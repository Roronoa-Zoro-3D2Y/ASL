...
public class ASL_RecyclerView_Word_Adapter extends RecyclerView.Adapter<ASL_RecyclerView_Word_Adapter.MyViewHolder> {
    Context context;
    ...
    public ASL_RecyclerView_Word_Adapter(Context context, ArrayList<AslModel> aslModelArrayList1, ASLRecyclerViewInterface aslRecyclerViewInterface, int RecyclerViewPos)
    {
...
*/
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(view,this.aslRecyclerViewInterface,this.aslTextBeingSet,MyPos);
    }


    public void onBindViewHolder(@NonNull ASL_RecyclerView_Word_Adapter.MyViewHolder holder, int position) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ImageView aslSign;
        TextView aslText;
        public MyViewHolder(@NonNull View itemView,ASLRecyclerViewInterface recyclerViewInterface,String aslTextClicked,int ThePos) {
            super(itemView);
...
//                            recyclerViewInterface.OnItemClick(aslModelArrayList2,pos);
                            recyclerViewInterface.OnRecyclerViewClick(pos,ThePos);
